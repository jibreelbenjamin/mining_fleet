  ...
  <div class="max-w-xl mx-auto">
    <div class="text-center">
      ...
      <p class="mt-1 text-gray-600 dark:text-neutral-300">
        Formulir permintaan menggunakan kendaraan
      </p>
    </div>

    <div class="mt-9">
      <!-- Form -->
      <form method="post" action="{{ route('dashboard.'.$page.'.create.action', $data->$id_data ?? '') }}">
        @csrf
        <div class="grid gap-4 lg:gap-6">
            <div>
                ...
                <select id="hs-scroll-to-selected" data-hs-select='{
                  ...
                  <option value="{{ $item->id_vehicle }}" {{ $item->id_vehicle == old('vehicle_id') ? 'selected' : '' }} 
            ...
            <div>
                ...
                <select id="hs-scroll-to-selected" data-hs-select='{
                  ...
                  <option value="{{ $item->id_driver }}" {{$item->id_driver == old('driver_id') ? 'selected' : '' }} data-hs-select-option='{
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
              <div>
                ...
                <input type="datetime-local" name="tanggal_mulai" value="{{ old('tanggal_mulai') }}" autocomplete="off" placeholder="Pilih tanggal ..." class="datetime py-2.5 sm:py-3 px-4 block w-full bg-white dark:bg-neutral-800 border-gray-200 dark:border-neutral-700 rounded-lg sm:text-sm text-gray-800 dark:text-neutral-200 placeholder:text-gray-500 dark:placeholder:text-neutral-400 focus:border-blue-700 dark:focus:border-blue-600 focus:ring-blue-700 dark:focus:ring-blue-600 disabled:opacity-50 disabled:pointer-events-none">
              </div>
              <div>
                <label class="block mb-2 text-sm text-gray-800 dark:text-neutral-200 font-medium">Tanggal selesai</label>
                <input type="datetime-local" name="tanggal_selesai" value="{{ old('tanggal_selesai') }}" autocomplete="off" placeholder="Pilih tanggal ..." class="datetime py-2.5 sm:py-3 px-4 block w-full bg-white dark:bg-neutral-800 border-gray-200 dark:border-neutral-700 rounded-lg sm:text-sm text-gray-800 dark:text-neutral-200 placeholder:text-gray-500 dark:placeholder:text-neutral-400 focus:border-blue-700 dark:focus:border-blue-600 focus:ring-blue-700 dark:focus:ring-blue-600 disabled:opacity-50 disabled:pointer-events-none">
              </div>
            </div>

            <div>
                <label class="block mb-2 text-sm text-gray-800 dark:text-neutral-200 font-medium">Tujuan</label>
                <input type="text" name="tujuan" value="{{ old('tujuan') }}" autocomplete="off" placeholder="Tambang Nikel A4 ..." class="py-2.5 sm:py-3 px-4 block w-full bg-white dark:bg-neutral-800 border-gray-200 dark:border-neutral-700 rounded-lg sm:text-sm text-gray-800 dark:text-neutral-200 placeholder:text-gray-500 dark:placeholder:text-neutral-400 focus:border-blue-700 dark:focus:border-blue-600 focus:ring-blue-700 dark:focus:ring-blue-600 disabled:opacity-50 disabled:pointer-events-none">
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
              <div>
                ...
                <select id="hs-scroll-to-selected" data-hs-select='{
                  ...
                  <option value="{{ $item->id_user }}" {{ $item->id_user == old('lvl2') ? 'selected' : '' }} data-hs-select-option='{
              ...
              <div>
                ...
                <select id="hs-scroll-to-selected" data-hs-select='{
                  ...
                  <option value="{{ $item->id_user }}" {{ $item->id_user == old('lvl1') ? 'selected' : '' }} data-hs-select-option='{
                      "description": "{{ $item->email }}"
                    }'>
                    {{ $item->nama }}
                  </option>
