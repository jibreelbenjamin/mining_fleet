        ...
        <div class="grid gap-4 lg:gap-6">
            ...
            {{-- <div>
                ...
                <select id="hs-custom-template-with-icons" data-hs-select='{
                  ...
                  <option value="1" {{ old('status') == 1 ? 'selected' : 'selected' }} data-hs-select-option='{
                ...
                <option value="2" {{ old('status') == 2 ? 'selected' : '' }} data-hs-select-option='{
                ...
                <option value="3" {{ old('status') == 3 ? 'selected' : '' }} data-hs-select-option='{
                ...
                <option value="4" {{ old('status') == 4 ? 'selected' : '' }} data-hs-select-option='{
